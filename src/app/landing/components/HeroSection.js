  ...
  return (
    <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8">
        {/* Version badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#262b33] bg-[#171a21]/50 px-4 py-1 text-xs font-medium text-[#3b82f6]">
          <span className="flex h-2 w-2 rounded-full bg-[#3b82f6] animate-pulse"></span>
          <span>MaxRouter v1.0 â€¢ Agente Lucas Integrado</span>
        </div>

        {/* Main heading */}
        <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight text-white">
          One Endpoint for <br />
          <span className="text-[#3b82f6]">All AI Providers</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full pt-2">
          <button
            ...
            className="h-12 px-8 rounded-lg bg-[#3b82f6] hover:bg-[#2563eb] text-[#0f1115] text-base font-bold transition-all shadow-[0_0_15px_rgba(59,130,246,0.45)] flex items-center gap-2"
          >
          ...
          <button
            ...
            className="h-12 px-8 rounded-lg border border-[#262b33] bg-[#171a21] hover:bg-[#262b33] text-white text-base font-bold transition-all flex items-center gap-2"
          >
