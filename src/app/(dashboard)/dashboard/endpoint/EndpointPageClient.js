        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {tunnelEnabled && !tunnelLoading && tunnelReachable ? (
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-brand-300 dark:border-amber-800 bg-brand-500/5 text-sm text-brand-600 dark:text-brand-400">
          ...
          <div className="bg-surface-2 border border-border-subtle rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Expose your local MaxRouter to the internet. No port forwarding, no static IP needed. Share endpoint URL with your team or use it in Cursor, Cline, and other AI tools from anywhere.
                </p>
              </div>
            </div>
          </div>
