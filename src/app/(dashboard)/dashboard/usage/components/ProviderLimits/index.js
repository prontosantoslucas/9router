...
export default function ProviderLimits() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-end">
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button
            ...
            className={`flex h-8 shrink-0 items-center gap-1 rounded-lg border px-2 text-xs transition-colors ${expiringFirst ? "border-brand-500/40 bg-brand-500/10 text-brand-500" : "border-black/10 text-text-primary hover:bg-black/5 dark:border-white/10 dark:hover:bg-white/5"}`}
      ...
      {expiringFirst && (
        <div className="rounded-xl border border-brand-500/20 bg-brand-500/10 px-3 py-2 text-xs text-amber-700 dark:text-brand-300">
