...
export default function LandingPage() {
  ...
  return (
    <div className="relative text-white font-sans overflow-x-hidden antialiased selection:bg-[#3b82f6] selection:text-white">
      {/* Animated Background */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#0f1115]">
        ...
        <div className="absolute top-0 left-1/4 w-[700px] h-[700px] bg-[#3b82f6]/12 rounded-full blur-[130px] animate-blob"></div>
        ...
        <div className="absolute bottom-0 left-1/2 w-[650px] h-[650px] bg-cyan-500/8 rounded-full blur-[130px] animate-blob" style={{ animationDelay: '4s', animationDuration: '25s' }}></div>
        
        {/* Vignette effect */}
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(circle at center, transparent 0%, rgba(15, 17, 21, 0.4) 100%)'
        }}></div>
      </div>
