...
export const TTS_MODELS_CONFIG = {
  ...
  "edge-tts": {
    defaults: [
      // ── PT-BR (todas as neurais oficiais) ──
      { id: "pt-BR-FranciscaNeural",  name: "Francisca (pt-BR) — feminina madura", type: "tts" },
      { id: "pt-BR-AntonioNeural",    name: "Antonio (pt-BR) — masculino maduro",  type: "tts" },
      { id: "pt-BR-BrendaNeural",     name: "Brenda (pt-BR) — feminina jovem",     type: "tts" },
      { id: "pt-BR-DonatoNeural",     name: "Donato (pt-BR) — masculino",          type: "tts" },
      { id: "pt-BR-ElzaNeural",       name: "Elza (pt-BR) — feminina",             type: "tts" },
      { id: "pt-BR-FabioNeural",      name: "Fabio (pt-BR) — masculino",           type: "tts" },
      { id: "pt-BR-GiovannaNeural",   name: "Giovanna (pt-BR) — feminina",         type: "tts" },
      { id: "pt-BR-HumbertoNeural",   name: "Humberto (pt-BR) — masculino grave",  type: "tts" },
      { id: "pt-BR-JulioNeural",      name: "Julio (pt-BR) — masculino",           type: "tts" },
      { id: "pt-BR-LeilaNeural",      name: "Leila (pt-BR) — feminina",            type: "tts" },
      { id: "pt-BR-LeticiaNeural",    name: "Leticia (pt-BR) — feminina",          type: "tts" },
      { id: "pt-BR-ManuelaNeural",    name: "Manuela (pt-BR) — feminina",          type: "tts" },
      { id: "pt-BR-NicolauNeural",    name: "Nicolau (pt-BR) — masculino",         type: "tts" },
      { id: "pt-BR-ThalitaNeural",    name: "Thalita (pt-BR) — feminina",          type: "tts" },
      { id: "pt-BR-ValerioNeural",    name: "Valerio (pt-BR) — masculino",         type: "tts" },
      { id: "pt-BR-YaraNeural",       name: "Yara (pt-BR) — feminina jovem",       type: "tts" },
      // ── PT-PT ──
      { id: "pt-PT-DuarteNeural",     name: "Duarte (pt-PT) — masculino",          type: "tts" },
      { id: "pt-PT-RaquelNeural",     name: "Raquel (pt-PT) — feminina",           type: "tts" },
      // ── EN ──
      { id: "en-US-AriaNeural",       name: "Aria (en-US) — feminina",             type: "tts" },
      { id: "en-US-GuyNeural",        name: "Guy (en-US) — masculino",             type: "tts" },
      { id: "en-US-JennyNeural",      name: "Jenny (en-US) — feminina",            type: "tts" },
      { id: "en-US-RogerNeural",      name: "Roger (en-US) — masculino",           type: "tts" },
      { id: "en-GB-SoniaNeural",      name: "Sonia (en-GB) — feminina",            type: "tts" },
      { id: "en-GB-RyanNeural",       name: "Ryan (en-GB) — masculino",            type: "tts" },
      // ── ES ──
      { id: "es-ES-ElviraNeural",     name: "Elvira (es-ES) — feminina",           type: "tts" },
      { id: "es-MX-JorgeNeural",      name: "Jorge (es-MX) — masculino",           type: "tts" },
      // ── Outros idiomas mais pedidos ──
      { id: "fr-FR-DeniseNeural",     name: "Denise (fr-FR)",                      type: "tts" },
      { id: "de-DE-KatjaNeural",      name: "Katja (de-DE)",                       type: "tts" },
      { id: "it-IT-ElsaNeural",       name: "Elsa (it-IT)",                        type: "tts" },
